            ...
            [
                html.Div(
                    [
                        ...
                        html.H2("Songs with numbers in the title", className="theme-title"),
                        html.P(
                            "Pick a song that fits the brief. We will review submissions before anything gets added to the playlist.",
